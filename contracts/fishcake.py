...
class Fishcake(FA2_token_metadata, FA2_administrator, FA2_pause, FA2_core):
    def __init__(self, admin, supply):
        ...
        FA2_core.__init__(self, config, paused=False,
                          administrator=admin, total_supply=supply, initialMint=False)

    # mint the total supply of tokens to the admin and block this entrypoint forever to prevent new mints
    @sp.entry_point
